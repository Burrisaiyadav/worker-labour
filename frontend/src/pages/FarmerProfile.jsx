            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 md:gap-4 mb-6 md:mb-8 lg:mb-12">
                    <div>
                        ...
                        <p className="text-[8px] md:text-[9px] lg:text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Manage your farm identity and preferences.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-1 space-y-4 md:space-y-6">
                        <div className="bg-white rounded-2xl md:rounded-[2.2rem] p-6 md:p-8 text-center shadow-xl shadow-gray-200/50 border border-white relative overflow-hidden group">
                             ...
                             <div className="relative z-10">
                                ...
                                <p className="text-[8px] md:text-[9px] font-black text-gray-400 uppercase tracking-widest mt-1 md:mt-1.5">Farmer • Verified Partner</p>
                                ...
                                <div className="grid grid-cols-2 gap-3 md:gap-4 mt-6 md:mt-8 pt-6 md:pt-8 border-t border-gray-50">
                                    <div className="text-center group-hover:scale-110 transition-transform">
                                        ...
                                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mt-0.5">Jobs Posted</p>
                                    </div>
                                    <div className="text-center group-hover:scale-110 transition-transform">
                                        ...
                                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mt-0.5">Expert Rating</p>
                                    </div>
                                </div>
                             </div>
                        </div>
                        ...
                        <button 
                            ...
                            className="w-full p-5 bg-white border border-gray-100 rounded-[1.8rem] flex items-center justify-center gap-2 text-[9px] font-black uppercase tracking-widest text-red-500 hover:bg-red-50 transition-all shadow-sm"
                        >
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        {/* Core Details */}
                         <div className="bg-white rounded-[2.2rem] p-8 shadow-xl shadow-gray-200/50 border border-white">
                            <div className="flex justify-between items-center mb-8">
                                <h3 className="text-xl font-black text-gray-900 uppercase tracking-tighter italic">Farm Identity</h3>
                                {isEditing ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-4">Farm Operations</label>
                                     {isEditing ? (
                                        <input 
                                            type="text" 
                                            value={user.farmSize || ''} 
                                        ...
                                        <div className="bg-green-50 border border-green-100 px-6 py-4 rounded-2xl flex items-center gap-3">
                                            ...
                                            <span className="font-black text-green-900 uppercase tracking-tight">{user.farmSize || 'Size Pending'}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        {/* Crops */}
                         <div className="bg-white rounded-[2.2rem] p-8 shadow-xl shadow-gray-200/50 border border-white">
                             <div className="flex justify-between items-center mb-8">
                                <h3 className="text-xl font-black text-gray-900 uppercase tracking-tighter italic">Crops Grown</h3>
                            </div>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {user.crops?.length === 0 ? (
                                    <div className="p-8 bg-gray-50 border border-gray-100 rounded-2xl w-full text-center">
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">No crops listed</p>
                                    </div>
                                ) : (
                                    user.crops?.map((crop, index) => (
                                        <div key={index} className="bg-green-50 border-2 border-green-100 pl-4 pr-3 py-3 rounded-2xl text-green-900 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 group transition-all hover:bg-green-100">
                                            <Sprout size={16} className="text-green-600"/> {crop}
                                            {isEditing && (
                                                <button onClick={() => handleDeleteCrop(crop)} className="h-6 w-6 bg-green-200 text-green-700 rounded-lg flex items-center justify-center hover:bg-red-500 hover:text-white transition-all">
                                                    <X size={12} />
                                                </button>
                                            )}
                                        </div>
                            ...
                            {isEditing && (
                                <div className="space-y-8 bg-gray-50 p-8 rounded-[2.5rem] border border-gray-100">
                                    <div>
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">Popular Choices</p>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        />
                                        <button onClick={() => handleAddCrop()} className="h-14 px-8 bg-green-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-green-100 flex items-center gap-2 hover:bg-green-700 transition-all">
                                            <Plus size={16} /> Add
                                        </button>
                                    </div>
                                </div>
